  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-gold selection:text-black overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-gold to-yellow-200 flex items-center justify-center font-black text-black text-xs">
                ACP
              </div>
              <span className="font-bold text-xl tracking-tight">AnaliseCard<span className="text-gold">Pro</span></span>
            </div>
            <div className="flex items-center gap-4">
              ...
              <button 
                onClick={() => navigate('/dashboard')}
                className="bg-gold text-black px-5 py-2 rounded-full text-xs font-black uppercase tracking-widest hover:scale-105 transition-all shadow-lg shadow-gold/20"
              >
                CRIAR MEU CARD
              </button>
            </div>
      ...
      <div className="relative pt-32 pb-20 sm:pt-48 sm:pb-32 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-indigo-600/10 rounded-full blur-[150px] -z-10 opacity-30 pointer-events-none"></div>
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-gold/5 rounded-full blur-[120px] -z-10 opacity-20 pointer-events-none"></div>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-gold text-[10px] font-black uppercase tracking-widest mb-8 animate-fade-in shadow-xl">
          ...
          <h1 className="text-5xl sm:text-8xl font-black tracking-tighter mb-8 leading-[0.9] animate-slide-up">
            Cartões que <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold via-yellow-200 to-gold">Vendem.</span><br />
            Dados que <span className="text-indigo-400">Convertem.</span>
          </h1>
          ...
          <p className="mt-4 max-w-3xl mx-auto text-lg sm:text-xl text-gray-400 mb-12 animate-slide-up font-medium leading-relaxed" style={{ animationDelay: '0.1s' }}>
            Pare de usar cartões gratuitos que são apenas links. Use a ferramenta profissional que integra <span className="text-white font-bold underline decoration-gold">Meta Pixel</span>, <span className="text-white font-bold underline decoration-indigo-400">GA4</span> e <span className="text-white font-bold underline decoration-white">UTMs Automáticas</span>.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-6 justify-center animate-slide-up" style={{ animationDelay: '0.2s' }}>
            <button 
                onClick={() => navigate('/dashboard')}
                className="px-10 py-5 bg-gold hover:bg-yellow-400 text-black font-black rounded-2xl text-lg transition-all transform hover:-translate-y-1 shadow-[0_0_30px_rgba(212,175,55,0.4)] uppercase tracking-widest text-xs"
            >
      ...
      {/* Why Section - The Marketing Angle */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex gap-4">
                            <div className="w-12 h-12 rounded-2xl bg-green-500/20 text-green-400 flex items-center justify-center shrink-0 border border-green-500/30">
                                <i className="fa-solid fa-sack-dollar"></i>
                            </div>
                            <div>
                                <h3 className="text-xl font-bold mb-2">ROI Transparente</h3>
                                <p className="text-gray-400 text-sm leading-relaxed">Corretores e Lojistas medem: "Gastei R$100 em anúncios, 150 pessoas viram meu cartão, 12 chamaram no WhatsApp". Isso é marketing profissional.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="relative">
                    <div className="absolute inset-0 bg-gold/20 blur-[100px] -z-10 rounded-full"></div>
                    <div className="bg-black/50 backdrop-blur-2xl border border-white/10 p-8 rounded-[3rem] shadow-2xl overflow-hidden group">
                        <div className="flex items-center justify-between mb-8">
                            <h4 className="font-bold text-xs uppercase tracking-[0.2em] text-gold">Analytics em Tempo Real</h4>
                            ...
                            {[
                                ...
                                <div key={i} className="space-y-2">
                                    ...
                                    <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                                        <div className="h-full bg-gold rounded-full" style={{ width: stat.p }}></div>
                                    </div>
                                </div>
                            ))}
                        </div>
      ...
      <section className="py-24 bg-black">
        <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <div className="max-w-sm mx-auto bg-gradient-to-b from-zinc-900 to-black border border-gold/20 p-10 rounded-[2.5rem] relative group hover:border-gold transition-all duration-500">
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-gold text-black text-[9px] font-black px-6 py-2 rounded-full uppercase tracking-widest shadow-xl">VITALÍCIO</div>
                
                <div className="mb-8">
                    <div className="text-gray-500 text-sm font-bold line-through mb-1">R$ 147,00</div>
                    <div className="flex items-end justify-center gap-1">
                        <span className="text-2xl font-bold text-gold mb-2">R$</span>
                ...
                <ul className="text-left space-y-4 mb-10">
                    {['Pixel Meta & GA4 Nativo', 'UTM Automática em links', 'Dashboard de Cliques', 'QR Code de Impressão', '7 Dias de Teste Grátis'].map((item, i) => (
                        <li key={i} className="flex items-center gap-3 text-xs font-bold text-gray-300">
                            <i className="fa-solid fa-check text-gold"></i> {item}
                        </li>
                    ))}
                </ul>
                ...
                <button 
                    onClick={() => navigate('/dashboard')}
                    className="w-full bg-white text-black font-black py-5 rounded-2xl hover:bg-gold transition-all uppercase tracking-widest text-xs shadow-lg"
                >
      ...
      <footer className="border-t border-white/5 py-12 bg-black text-center">
        <div className="max-w-7xl mx-auto px-4">
            <div className="flex items-center justify-center gap-2 mb-6 grayscale opacity-50">
                <div className="w-6 h-6 rounded bg-gold flex items-center justify-center font-black text-black text-[8px]">ACP</div>
                <span className="font-bold text-sm tracking-tight">AnaliseCardPro</span>
            </div>
